...
<div class="card">
    <div class="card-body">
        ...
        <form class="forms-sample" action="<?= site_url('categories/update/' . $categories['id_categories']) ?>"
            method="post">
            <?= csrf_field() ?>
            <div class="form-group">
                <label for="name_categories">Name</label>
                <input type="text" class="form-control" id="name_categories"
                    value="<?= $categories['name_categories'] ?>" name="name_categories" placeholder="Username">
            </div>
            <div class="form-group">
                <label for="detail_categories">Detail</label>
                <input type="text" class="form-control" id="detail_categories"
                    value="<?= $categories['detail_categories'] ?>" name="detail_categories" placeholder="Email">
            </div>
