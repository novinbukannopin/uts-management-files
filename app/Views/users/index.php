            ...
            <form class="search-form" action="" method="get">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="">
                        ...
                        <button class="btn btn-success btn-lg text-white mb-0 me-0" name="submit" type="submit" value=" <?= $request->getGet('keyword') ?>"> <i class=" mdi mdi-search"></i>Cari
                        </button>
                    </div>
            </form>
            <div class="">
                    ...
                    <?php if ($value) { ?>
                        <tr class="align-middle">
                            ...
                            <td class="d-flex align-items-center gap-3">
                                <div class="">
                                    <a href="<?= site_url('users/edit/' . $value['id_user']) ?>">
                                        <button class="btn btn-warning m-0">Edit</button>
                                    </a>
                                </div>
                                <div class="">
                                    <button class="btn btn-danger m-0" data-bs-toggle="modal" data-bs-target="#modal-Delete-<?= $value["id_user"] ?>">Delete</button>
                                </div>
