    ...
    setTimeout(() => {
      ...
      if (newRecord) {
        newRecord.addEventListener("click", function () {
          ...
          // (offCanvasElement.querySelector('.dt-name-categories').value = ''),
          // (offCanvasElement.querySelector('.dt-detail-categories').value = ''),
    ...
    fv = FormValidation.formValidation(formAddNewRecord, {
      fields: {
        name_categories: {
          validators: {
            notEmpty: {
              message: "Name Categories is required",
            },
          },
        },
        detail_categories: {
      ...
      buttons: [
        {
          extend: "collection",
          className:
            "btn btn-label-primary btn-secondary buttons-collection dropdown-toggle me-2",
          text: '<span><i class="mdi mdi-export-variant me-sm-1"></i><span class="d-none d-sm-inline-block">Export</span></span>',
          buttons: [
            {
              extend: "print",
